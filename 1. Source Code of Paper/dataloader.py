...
class CustomDataset(Dataset):
    def __init__(self, df):
        #self.normal = torch.tensor(df.iloc[5:, :9].values.tolist())
        #self.AD = torch.tensor(df.iloc[5:, 9:45].values.tolist())
        #self.FB = torch.tensor(df.iloc[5:, 45:216].values.tolist())
        #self.DSV = torch.tensor(df.iloc[5:, 216:432].values.tolist())
        #self.SHORT = torch.tensor(df.iloc[5:, 432:].values.tolist())
...
class Disable_degreee_Dataset(Dataset):
    def __init__(self, df):
        #self.normal = torch.tensor(df.iloc[5:, :9].values.tolist())
        #self.AD = torch.tensor(df.iloc[5:, 9:45].values.tolist())
        #self.FB = torch.tensor(df.iloc[5:, 45:216].values.tolist())
...
class Custom_10_Dataset(Dataset):
    def __init__(self, df):
        #self.normal = torch.tensor(df.iloc[5:, :9].values.tolist())
        #self.AD = torch.tensor(df.iloc[5:, 9:45].values.tolist())
        #self.FB = torch.tensor(df.iloc[5:, 45:216].values.tolist())
...
class Disable_degreee_10_Dataset(Dataset):
    def __init__(self,df):
...
class Disable_degreee_EE_Dataset(Dataset):
    def __init__(self):
        df = pd.read_csv('EE.csv')
...
class Disable_degreee_TF_Dataset(Dataset):
    def __init__(self):
        df = pd.read_csv('TF.csv')
        self.labels = label_degree_EEandTF()
