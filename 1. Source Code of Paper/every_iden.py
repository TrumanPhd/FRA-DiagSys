...
# Define batch size for your data loaders
batch_size = 32
...
model = FiveClassClassifierWithSoftmax(num_classes=63).to(device)
...
early_stopping_patience = 65  # 设定早停的耐心值
early_stopping_counter = 45  # 用于计算连续验证损失上升的次数
