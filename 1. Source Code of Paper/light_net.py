...
for test_num in range(10):
    ...
    model = FiveClassClassifierWithSoftmax(dropout=True).to(device)
    ...
    training_name = "Fault Type Recognition "+str(test_num)  # 替换为您希望的名称
    ...
    early_stopping_counter = 50  # 用于计算连续验证损失上升的次数
